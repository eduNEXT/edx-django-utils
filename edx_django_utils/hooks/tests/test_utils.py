...
class TestUtilityFunctions(TestCase):
    ...
    def test_get_non_existing_function(self):
        ...
        log_message = (
            "Failed to retrieve 'non_existent' function from path "
            "'edx_django_utils.hooks.tests.test_utils.non_existent'."
        )
    ...
    def test_get_non_existing_module_func(self):
        ...
        log_message = (
            "Failed to import 'edx_django_utils.hooks.non_existent.test_utils' "
            "module when getting 'test_function' function."
        )
    ...
    def test_get_empty_hook_config(self):
        ...
        when a trigger without a HOOKS_EXTENSIONS_CONFIG is passed as parameter.
    ...
    def test_get_hook_config(self):
        """
        This method is used to verify the behavior of get_hook_configurations
        when a trigger with HOOKS_EXTENSIONS_CONFIG defined is passed as parameter.
    ...
    @ddt.unpack
    def test_get_no_pipeline_config(self, config, expected_result, get_config_mock):
        """
        This method is used to verify the behavior of get_pipeline_configuration
        when the configuration HOOKS_EXTENSIONS_CONFIG for trigger name does not have the
        entire configuration.

        Expected behavior:
            Returns a tuple with a missing configuration.
        """
    ...
    @patch("edx_django_utils.hooks.utils.get_hook_configurations")
    def test_get_pipeline_config(self, get_config_mock):
        """
        This method is used to verify the behavior of get_pipeline_configuration
        when a trigger with HOOKS_EXTENSIONS_CONFIG defined is passed as parameter.
        ...
        is_async = False
        get_config_mock.return_value = {"pipeline": pipeline, "async": is_async}
        expected_result = (
            pipeline,
            is_async,
        )
